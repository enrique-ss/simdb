import { getCurrentUserProfile, getUserProgress, getUserLists, getMediaReviews } from '../supabase-client.js';
        ...
        tabContent = `
            <div class="section">
                <div style="display: flex; gap: 8px; margin-bottom: 16px; overflow-x: auto; padding-bottom: 4px;">
                    ...
                    <button class="category-card-btn lib-sub-tab" data-sub="book" style="padding: 6px 12px; font-size: 0.8rem;">${BOOK_ICON_EMOJI} Leitura</button>
                </div>
        ...
        createListBtn.addEventListener('click', async () => {
            ...
            if (title) {
                ...
                await fetch('/api/lists', {
                    ...
                    body: JSON.stringify({ user_id: sessionUser.id, title, description: 'Lista criada pelo usuário' })
                });
